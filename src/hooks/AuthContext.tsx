...
export const AuthUser: React.FC = ({ children }: any) => {
  ...
  const logon = useCallback(async ({ email, cnpj, password }: LogonCredentials) => {
  ...
  const delItem = useCallback(async ({ id, itemId, token }: DeleteCredentials) => {
